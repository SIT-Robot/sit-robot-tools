...
def speed_handle(e):
    ...
    for i, (control, target, delta) in enumerate(((control_speed_x, target_speed_x, 0.006),
                                                  (control_speed_y, target_speed_y, 0.006),
...
rospy.Timer(rospy.Duration(0.1),speed_handle)
